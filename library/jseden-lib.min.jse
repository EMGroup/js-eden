...
picture is [Image(_view_picture_width / 2 - eval(${{edenUI.branding.logo.width}}$ / 2), _view_picture_height / 2 - eval(${{edenUI.branding.logo.height}}$ / 2), eval(${{edenUI.branding.logo.url}}$))];
}
