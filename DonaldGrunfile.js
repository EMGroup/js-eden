...
module.exports = function (grunt) {
  grunt.initConfig({
    ...
    jison: {
      target: {
        options: { moduleName: 'donaldParser' },
        files: { 'js/core/donald-translator.js': 'donald-translator/grammar.jison' }
      }
    },
    ...
    watch: {
      ...
      grammar: {
        files: 'donald-translator/grammar.jison',
        tasks: ['jison']
      },

      // reload browser when parser changes
      parser: {
        files: 'js/eden/core/donald-translator.js',
        options: {
          livereload: true
        }
      }
      ...
      livereload: {
        options: {
          middleware: function (connect) {
            return [
              lrSnippet,
              connect.static(path.resolve('donald-translator')),
