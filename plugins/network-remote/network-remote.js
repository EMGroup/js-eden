EdenUI.plugins.NetworkRemote = function(edenUI, success){
	...
	function clickConnect() {
		eden.root.lookup("network_address").assign($("#nr-ipaddr").val(), eden.root.scope);
		eden.root.lookup("network_port").assign($("#nr-port").val(), eden.root.scope);
		eden.root.lookup("network_key").assign($("#nr-key").val(), eden.root.scope);
		//eden.root.lookup("network_connect").assign($("#nr-ipaddr").val());
		me.connect();
	}

	me.connect = function() {
		var ipaddr = eden.root.lookup("network_address").value();
		var port = eden.root.lookup("network_port").value();
		var key = eden.root.lookup("network_key").value();
...
"<p id=\"nr-status\"></p>";
	...
	eden.root.lookup("plugins_network_loaded").assign(true, eden.root.scope);
};
