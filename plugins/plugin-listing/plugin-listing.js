...
EdenUI.plugins.PluginManager = function (edenUI, success) {
	...
	this.displayAbout = function () {
		edenUI.plugins.HTMLContent.html("About_JSEDEN",
			...
			<p>JS-EDEN was created by Tim Monks in 2010&ndash;11 as the topic of his MSc thesis.  The user interface was improved during July 2012 by Joe Butler, Matt Cranham, Hui Zhu and others.  This summer project resulted in a version of JS-EDEN codenamed "emile".  Emile was successfully used to teach students of the CS405 Empirical Modelling module at Warwick during autumn term 2012.  The current user interface was mostly developed by Nick Pope and a version with this style of interface was used to teach Warwick students during autumn term 2013.  Very little code from the emile version remains in the current version apart from the core functionality retained from Tim Monks\' original code.  However, the emile project was essential for proving JS-EDEN\'s worth as a valuable educational tool.</p> \
			<p>Tim Monks and Nick Pope established JS-EDEN as an open source project on <a href="https://github.com/EMGroup/js-eden" target="github">GitHub</a>.  All of the supportive infrstructure that\'s present in the background such as the automated test frameworks are down to Tim Monks\' careful discipline.  Jonny Foss also assists in completing complicated code merges and Elizabeth Hudnott just shoves an awful lot of code into the repository without caring too much about the back end details.</p> \
			<p>Since at least autumn 2013 there has always been someone who was the go-to person people approached whenever they needed a bug fixing or simply had to have a new feature added urgently.  At different points in time several different people have taken on this role and without them the project may not have succeeded.  Joe Butler admirably provided this form of technical support to the tutors during the 2013/14 academic year at a time when it was critical that JS-EDEN worked properly for students who were completing their coursework.  Tim Monks has also fixed a lot of bugs and helped Elizabeth Hudnott get up to speed.  We all very much indebted to Tim and there are still some parts of the code that only Tim knows how to troubleshoot.  As of March 2015 Elizabeth is the go-to person, providing technical support to fellow members of the CONSTRUIT! project.  Joking aside, the official place to report bugs to the whole development team is the <a href="https://github.com/emgroup/js-eden/issues" target="github">GitHub issues list</a> rather than any individual\'s personal inbox.</p> \
			<h2>Contributors of Specific Features</h2> \
			<ul> \
				<li>The EDEN language compiler and the JS-EDEN dependency maintainer were created by Tim Monks in 2010&ndash;11 as the topic of his MSc thesis.  These components remain at the core of everything that JS-EDEN does and Tim\'s work is of such outstanding quality that the core functionality always works reliably and seldom requires others to make improvements.  Elizabeth is familiar with many (but not all) of technical details of Tim\'s work and has tried to make some small additions such as adding support for EDEN\'s eval(), which was previously absent from JS-EDEN.</li> \
				<li>The windowed user interface was created by Nick Pope.  Some subsequent ehancements have been made by Jonny Foss, Elizabeth Hudnott and Tim Monks.</li> \
				...
				<li>Jonny Foss created the state listener and window layout tool.  The state listeneer has been an essential tool for the CONSTRUIT! project as it is this that permits collaborative work sessions to take place over the internet between partners at geographically distance locations.  Jonny Foss and Elizabeth Hudnott have also worked together to add support for expression tree input.</li> \
