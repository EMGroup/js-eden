...
EdenUI.plugins.PluginManager = function (edenUI, success) {
	...
	this.displayAbout = function () {
		edenUI.plugins.HTMLContent.html("About_JSEDEN",
			...
			<p>Tim Monks and Nick Pope established JS-EDEN as an open source project on GitHub.  All of the supportive infrstructure that\'s present in the background such as the automated testing frameworks are down to Tim Monks\' careful discipline.  Jonny Foss also assists in completing complicated code merges and Elizabeth Hudnott shoves an awful lot of code into the repository without having enough time to care too much about the back end details.</p> \
