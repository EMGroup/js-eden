...
Ellipse.prototype.draw = function (context, scale) {
...
var lineWidth = this.tracePath(context, scale, scaleOutline);
...
Ellipse.prototype.tracePath = function (context, scale, scaleOutline) {
...
this.tracePath(context, scale, false);
return context.isPointInPath(x,y);
}
