...
var autoWidth = me.width === undefined;
var autoHeight = me.height === undefined;
...
var widthSymName = me.name + "_width";
var heightSymName = me.name + "_height";
var scale = me.cachedScale;
...
this.drawingOptions.arrowhead.draw(context, scale, x1, y1, gradient, false, x2, y2, gradient, false);
}
};
...
//Probably not an actual function call but radiansPerUnit observable changed.
return undefined;
...
eden.error(new Error("angleTurned: This function requires at most 2 arguments"), "error");
return undefined;
}
if (to === undefined) {
return undefined;
...
this.drawingOptions.arrowhead.draw(context, scale, vertex0.x, vertex0.y, gradient1, false,
vertexN.x, vertexN.y, gradient2, false);
}
};
