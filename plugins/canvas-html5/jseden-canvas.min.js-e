...
placeholder + ' class="canvashtml-item"/>');
...
var valignRE = /\b(top|hanging|middle|baseline|alphabetic|ideographic|bottom)\b\s*/;
this.drawingOptions = {valign: top};
var drawingOptions = this.drawingOptions;
options = options.replace(valignRE, function (match, alignment) {
drawingOptions.valign = alignment;
return "";
});

var halignRE = /\b(left|right|center|centre|start|end)\b/;
options = options.replace(halignRE, function (match, alignment) {
drawingOptions.align = alignment;
return "";
});
...
>>>>>>> 15e1a8fd4457348b272f1a20cc0f204391a996a9
