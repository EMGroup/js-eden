...
var s = "Ellipse(" + this.x + ", " + this.y + ", " + this.xradius + ", " + this.yradius + ", " +
Eden.edenCodeForValue(this.fillcolour) + ", " + Eden.edenCodeForValue(this.outlinecolour);
...
", " + this.y2 + ", " + Eden.edenCodeForValue(this.colourStops) + ")";
...
var s = "Polygon(" + Eden.edenCodeForValue(this.vertices) + ", " +
Eden.edenCodeForValue(this.fillcolour) + ", " + Eden.edenCodeForValue(this.outlinecolour);
...
return "Pixel("+ this.x + ", " + this.y + ", \"" + this.colour + "\")";
};
...
return "PixelList(" + (this.data.length / 4).toString() + " pixel values, " + this.x + ", " + this.y + ", " + this.width + ")";
}

PixelList.prototype.getEdenCode = function() {
return "PixelList(" + Eden.edenCodeForValue(this.data) + ", " + this.x + ", " + this.y + ", " +
this.width + ")";
}
...
return "RadialGradient(" + this.x1 + ", " + this.y1 + ", " + this.r1 +
", " + this.x2 + ", " + this.y2 + ", " + this.r2 + ", " +
Eden.edenCodeForValue(this.colourStops) + ")";
...
return "RadioButtons(" + this.name + ", " + Eden.edenCodeForValue(this.buttonValues) + ", " +
...
return "Shadow(" + Eden.edenCodeForValue(this.colour) + ", " + this.xOffset + ", " +
this.yOffset + ", " + this.blur + ", " + this.scale + ")";
}
...
Eden.edenCodeForValue(this.height) + ", " + Eden.edenCodeForValue(this.placeholder) + ", " +
Eden.edenCodeForValue(this.enabled) + ")";
};
