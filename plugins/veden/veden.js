EdenUI.plugins.Veden = function(edenUI, success) {
	...
	VedenElement.prototype.snap = function(ele, dest, src) {
	...
	function VedenListIndex(data, x, y) {
	...
	function VedenNumber(value, x, y) {
		VedenElement.call(this,"number", x, y, ((""+value).length-1) * 7 + 30, 20);
		this.value = value;
		this.element = this.make();
	...
	function VedenExpGroup(data, x, y) {
	...
	var elementFactory = {
		"statement": VedenStatement,
		"modifier": VedenModifier,
		"number": VedenNumber,
		"observable": VedenObservable,
		"lvalue": VedenLValue,
		"operator": VedenOperator,
		"index": VedenListIndex,
		"group": VedenExpGroup
	}
