...
Veden.List.prototype.make = function () {
	...
	box.setAttribute("style","fill:#d5f7d4;fill-opacity:1;fill-rule:evenodd;stroke:#21ad1c;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1;stroke-miterlimit:4;stroke-dasharray:none");
	...
	lblock.setAttribute("style", "fill:#21ad1c;fill-opacity:1;stroke:none;stroke-opacity:1");
	...
	rblock.setAttribute("style", "fill:#21ad1c;fill-opacity:1;stroke:none;stroke-opacity:1");
	//node.setAttribute("transform", "scale(" + 0.4 + " " + 0.4 +")");
	...
	this.onattachchild = function() {
		...
		for (var i=0; i<me.snappoints.length; i++) {
			...
			if (me.snappoints[i].element) {
				...
				extents = {x: me.snappoints[i].getX(), y: me.snappoints[i].getY()-10, width: me.snappoints[i].getX()+10, height: 0};
			}
			...
			if (me.snappoints[i].external) {
				...
				curleft += extents.width + 15;
			}
		}

		me.autoMove();
		me.minWidth = curleft+10;
