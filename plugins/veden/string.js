Veden.String = function(value, x, y) {
	Veden.Element.call(this,"string", x, y, ((""+value).length-1) * 7 + 30, 20);
	this.value = value;
	this.element = this.make();

	this.snappoints = [
		new SnapPoint(this, "left", 0, 0, 0.5, 0, true, ["operator","group", "index","modifier","when"], ["cond","right","inside"]),
		new SnapPoint(this, "right", 1.0, 0, 0.5, 0, true, ["operator","index"],["left"])
	];
}

inherits(Veden.String, Veden.Element);

Veden.String.prototype.toString = function() {
	return ""+this.value;
}

Veden.String.prototype.make = function () {
	...
	box.setAttribute("style","fill:#b6381e;fill-opacity:1;fill-rule:evenodd;stroke:none;stroke-width:1.0px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1");
	...
	input.setAttribute("class", "veden-string-input");
