...
(function () {
	...
	EdenUI.prototype.createView = function (name, type) {
		...
		this.eden.executeEden("proc _View_"+name+"_position : _view_"+name+"_x,_view_"+name+"_y { ${{ edenUI.moveView(\""+name+"\"); }}$; };", function () {
			this.eden.executeEden("proc _View_"+name+"_size : _view_"+name+"_width,_view_"+name+"_height { ${{ edenUI.resizeView(\""+name+"\"); }}$; };");
		});
		return this.viewInstances[name];
	};
